package hcmute.edu.vn.externalstorage.TranQuocTuan20110595;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void savePublicly(View view) {
        ...
        File file = new File(folder, "TQTData.txt");
    ...
    public void savePrivately(View view) {
        ...
        File folder = getExternalFilesDir("TranQuocTuan");

        // Creating file with name gfg.txt
        File file = new File(folder, "TQT.txt");
        writeTextData(file, editTextData);
        editText.setText("");
    }
